...
import { type DocumentActionDescription, type DocumentActionConfirmDialogProps, useClient } from 'sanity';
...
export default (props: ShopifyDocumentActionProps): DocumentActionDescription | undefined => {
  ...
  const client = useClient({ apiVersion: process.env.NEXT_PUBLIC_SANITY_API_VERSION!! });
