...
import { IFullscreenImageSection } from '@/tools/sanity/schema/sections/shared/fullScreenImageSection';
import styles from './styles.module.scss';

const FullscreenImageSection: React.FC<IFullscreenImageSection> = props => {
