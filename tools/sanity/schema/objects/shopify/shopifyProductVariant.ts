...
import { IInventoryObject } from './inventory';

interface IShopifyProductVariantObject {
  createdAt: string;
  updatedAt: string;
  status: string;
  isDeleted: boolean;
...
const shopifyProductVariant = defineField({
...
export default shopifyProductVariant;
export type { IShopifyProductVariantObject };
