...
import { IShopifyCollectionRuleObject } from './shopifyCollectionRule';

interface IShopifyCollectionObject {
  createdAt: string;
  updatedAt: string;
  isDeleted: boolean;
  title: string;
  ...
  imageUrl: string;
  rules: IShopifyCollectionRuleObject[];
  disjunctive: boolean;
  sortOrder: string;
}

const shopifyCollection = defineField({
...
export type { IShopifyCollectionObject };
